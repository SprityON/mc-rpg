...
class Client extends BaseClient {
  ...
  /**
   * Makes it easier to use client methods.
   * @type {Object}
   */
  Functions = {

    /**
     * Searches a string in the client cache which, if found, will return the emoji.
     * @param e Parameter which will be a Discord emote.
     * @returns 
     */
    findEmoji: (e) => {
      return this.emojis.cache.find(emote => emote.name === e)
    }
  }
